...
const ServiceCard =({index, title, icon}) => {
 ...
 <Tilt className='xs:w-[250px] w-full'>
  ...
  >
    ...
    <img 
    src={icon} alt={title}
    className='w-16 h-16 mb-10 mt-10 ml-10 object-contain'
    />
